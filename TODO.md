...
- [ ] 2.1 `RedDotSaveData` + `JournalEntry` 직렬화 모델
- [ ] 2.2 `IRedDotPersistence` 인터페이스 (Save/SaveAll/Load/Clear)
- [ ] 2.3 `RedDotContainer` 수정 — Create에 키 시리얼라이저 추가, Export/Import
- [ ] 2.4 `RedDotSour` 수정 — SetPersistence, Save/Load/Compact
- [ ] 2.5 `JournalFilePersistence` 구현
- [ ] 2.6 `PlayerPrefsPersistence` 구현
- [ ] 2.7 Persistence 테스트
...
- [ ] 4.3 `SampleRedDotBadge` (이벤트 구독 → UI 반영 참고 예시)
- [ ] 4.4 샘플 씬
- [ ] 4.5 package.json에 sample 등록

### Phase 5: 패키지화 + Documentation
- [ ] 5.1 asmdef 파일 (Runtime, Editor, Tests)
- [ ] 5.2 package.json (UPM)
- [ ] 5.3 패키지 README.md
- [ ] 5.4 CHANGELOG.md
- [ ] 5.5 루트 README 업데이트
- [ ] 5.6 최종 정리 + v2.0.0 태그
